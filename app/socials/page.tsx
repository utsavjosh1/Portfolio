...
const SocialLink = () => {
  return (
    <div className="relative flex flex-col items-center justify-center pt-10 h-full w-full mx-auto text-black dark:text-white px-4 sm:px-6 lg:px-8 max-w-2xl">
      <motion.div
