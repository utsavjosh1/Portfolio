...
const ConnectSection = () => (
  <motion.section
    className="mt-8 w-full mb-24 text-black dark:text-[#E0E0E0]"
  ...
  >
    ...
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4 group">
      <div className="flex items-center justify-center p-3 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group-hover:opacity-50 hover:!opacity-100 dark:border-gray-600">
        <Link href="mailto:utsavjoshi602@gmail.com" className="flex items-center">
          <IconMail className="mr-2" />
          <span>Email</span>
        </Link>
      </div>
      <div className="flex items-center justify-center p-3 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group-hover:opacity-50 hover:!opacity-100 dark:border-gray-600">
        <Link href="https://www.linkedin.com/in/joshi-utsav/" className="flex items-center">
          <IconBrandLinkedin className="mr-2" /> 
          <span>LinkedIn</span>
        </Link>
      </div>
      <div className="flex items-center justify-center p-3 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group-hover:opacity-50 hover:!opacity-100 dark:border-gray-600">
        <Link href="https://instagram.com/joshi___utsav/" className="flex items-center">
      ...
      <div className="flex items-center justify-center p-3 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group-hover:opacity-50 hover:!opacity-100 dark:border-gray-600">
        <Link href="https://twitch.tv/1xki11er/" className="flex items-center">
          <IconBrandTwitch className="mr-2" /> 
          <span>Twitch</span>
        </Link>
      </div>
    </div>
