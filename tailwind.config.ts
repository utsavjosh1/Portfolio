  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "pulse-medium": "pulse-medium 2.5s ease-in-out infinite 0.3s",
        "pulse-fast": "pulse-fast 2s ease-in-out infinite 0.6s",
        "fade-in-up": "fade-in-up 0.8s ease-out 0.2s both",
        "fade-in-up-delay": "fade-in-up 0.8s ease-out 0.4s both",
      },
      typography: {
        DEFAULT: {
          css: {
