  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "fade-up-4": "fade-up 0.8s var(--ease) 0.4s forwards",
        "fade-up-5": "fade-up 0.8s var(--ease) 0.6s forwards",
        "fade-up-6": "fade-up 0.8s var(--ease) 0.8s forwards",
        "fade-up-7": "fade-up 0.8s var(--ease) 1.0s forwards",
